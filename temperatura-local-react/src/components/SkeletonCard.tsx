    ...
    <div className="animate-pulse rounded-2xl border border-white/25 bg-white/10 p-6 backdrop-blur-md">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="grid w-full gap-3">
          {/* Temperature */}
          <div className="mx-auto h-9 w-28 rounded-lg bg-white/20" />
          {/* Feels like */}
          <div className="mx-auto h-4 w-32 rounded bg-white/10" />
          {/* Description */}
          <div className="mx-auto h-6 w-36 rounded bg-white/15" />
          {/* Humidity + Wind */}
          ...
          {/* Clock */}
          <div className="mx-auto h-4 w-36 rounded bg-white/10" />
          {/* Suggestion */}
          <div className="mx-auto mt-2 h-8 w-full rounded-lg bg-white/5" />
        </div>
      </div>
    </div>
  );
