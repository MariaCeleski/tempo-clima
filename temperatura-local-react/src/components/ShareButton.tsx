...
export function ShareButton({ data }: ShareButtonProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 mt-2 w-48 animate-fadeInUp rounded-xl border border-white/20 bg-slate-900/95 p-2 shadow-xl backdrop-blur-lg">
